...
## v0.9.0 — 2026-06-27 (编号对齐)

**代码同 v0.2.2** (P0 hotfix 修两个 bug), 无新逻辑变化. 跳号到 0.9.0 是为了把
固件 / SDK CORE_VERSION / mods CORE_VERSION 三处统一编号 — 之前 SDK 走 0.2.x
跟项目里程碑 v0.8.x 不一致, 对外沟通混乱.

自本版起一个版本号覆盖三处. 老用户从 v0.2.1 直跳 v0.9.0, 不要回中间版本
(v0.2.0/v0.2.1 含 bug, v0.2.2 是临时过渡版亦可跳过).
