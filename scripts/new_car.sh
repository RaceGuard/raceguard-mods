...
echo ""
echo "2. 启用 mod (一条命令搞定 active_mods.cpp + platformio.ini):"
echo "   ./scripts/enable_mod.sh cars ${NEW_CAR}"
echo ""
echo "3. 烧机验证:"
echo "   ./scripts/flash_all.sh                  # 等价于 pio run -t upload + uploadfs"
echo "   pio device monitor -b 115200            # 看启动日志"
echo ""
echo "4. 实车测试 ≥30 min 覆盖怠速+城市+高速, 详见 docs/ADD_CAR_PROFILE.md"
echo ""
echo "5. PR 提交: 用 branch feat/cars/${NEW_CAR}, commit prefix feat(cars):"
